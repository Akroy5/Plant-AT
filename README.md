...
🔬 Disease Classification| Model        | Params  | Acc    | Precision | Recall | F1     | AUC    | MCC    |
| ------------ | ------- | ------ | --------- | ------ | ------ | ------ | ------ |
...
Plant Type Classification| Model        | Params  | Acc    | AUC    |
| ------------ | ------- | ------ | ------ |
...
Nagappagol, A., et al. (2025). Plant‑AT: Customized Hybrid Attention Model for Diagnosing Plant Disease. Springer Nature. https://link.springer.com/book/10.1007/978-3-031-93691-3
